 ...
 *
 *    Keep the ElementsJustItemCleaner object in this class and all calls to this object
...
public class JustItemCleaner {
	...
	@Mod.Instance(MODID)
	public static JustItemCleaner instance;
	public ElementsJustItemCleaner elements = new ElementsJustItemCleaner();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsJustItemCleaner.GuiHandler());
